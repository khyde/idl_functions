; $ID:	SHAPEFILE_2LONLAT.PRO,	2023-09-21-13,	USER-KJWH	$
...
;	****************************************************************************************************
  ...
  OUTFILE = !S.SHAPEFILES + 'LONLAT_SAVES' + SL + 'LONLAT-' + FP.NAME + '.SAV' 
  CSVFILE = !S.SHAPEFILES + 'LONLAT_SAVES' + SL + 'LONLAT-' + FP.NAME + '.CSV'
  PNGDIR =  !S.SHAPEFILES + 'OUTLINES'  + SL  
  DIR_TEST, [!S.SHAPEFILES + 'LONLAT_SAVES' + SL, PNGDIR]
