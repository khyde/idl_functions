...
;#################################################################################################
  ...
  PNGDIR    = !S.IDL_SHAPEFILES + 'PNGS'  + SL & DIR_TEST, PNGDIR
  OUTDIR    = !S.IDL_SHAPEFILES + 'OUTLINES' + SL & DIR_TEST, OUTDIR
  SHPDIR    = !S.IDL_SHAPEFILES + 'SHAPES' + SL + SHP + SL & DIR_TEST, SHPDIR
