; $ID:	PROJECT_SUBAREA_PLOTS.PRO,	2023-09-21-13,	USER-KJWH	$
  PRO PROJECT_SUBAREA_PLOTS

;+
; NAME:
;   PROJECT_SUBAREA_PLOTS
;
; PURPOSE:
;   $PURPOSE$
;
...
;
; CALLING SEQUENCE:
;   PROJECT_SUBAREA_PLOTS,$Parameter1$, $Parameter2$, $Keyword=Keyword$, ....
;
; REQUIRED INPUTS:
...
;-
; ****************************************************************************************************
  ROUTINE_NAME = 'PROJECT_SUBAREA_PLOTS'
  COMPILE_OPT IDL2
  SL = PATH_SEP()


END ; ***************** End of PROJECT_SUBAREA_PLOTS *****************
