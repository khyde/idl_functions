        ...
        FOR T=0, N_ELEMENTS(PRDS)-1 DO BEGIN
          ...
          FOR Y=0, N_ELEMENTS(PYRS)-1 DO BEGIN
            ...
            IF IDLTYPE(IMG) EQ 'OBJREF' THEN BEGIN
              ...
              IF KEYWORD_SET(YEAR_COMBO) AND R EQ 1 THEN TX = TEXT(IPOS[0]+(IPOS[2]-IPOS[0])/2,IPOS[1]-SPACE/2,AYEAR,/DEVICE,ALIGNMENT=0.5,VERTICAL_ALIGNMENT=1, FONT_SIZE=TFONT_SIZE)
