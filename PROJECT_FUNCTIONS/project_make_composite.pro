          ...
          FOR Y=0, N_ELEMENTS(PYRS)-1 DO BEGIN
            ...
            IF IDLTYPE(IMG) NE 'OBJREF' THEN BEGIN
              ...
              IF TSET NE [] THEN BEGIN
                IF KEYWORD_SET(COMPOSITE_MONTH) THEN FILE = GET_FILES(TSET,PRODS=TEMP_PROD,PERIOD=PER.PERIOD_CODE,FILE_TYPE=ATYPE, DATERANGE=PLOT_YEAR) $
            ...
            IF W EQ [] THEN BEGIN
              ...
              IF NCOL GT 6 THEN TFONT_SIZE = FONT_SIZE*0.5 ELSE TFONT_SIZE = FONT_SIZE
