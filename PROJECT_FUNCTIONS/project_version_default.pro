...
; Not sure if the above or below part is correct
  ...
  FOR P=0, N_ELEMENTS(PRODS)-1 DO BEGIN
    ...
    CASE SPROD OF
      ...
      'BTEMP':      BEGIN & DTSET=BT_DATASET  & TPSET=BT_TEMP  & SPROD=SPROD & DWLPROD='' & PTAG='AMEAN' & PSCALE='TEMP_0_20' & PAL='PAL_BLUEYELLOWRED'   & GSCALE=PSCALE  & GPAL='PAL_DEFAULT' & ASCALE='DIF_-5_5' & AGSCALE='DIF_-2_2' & APAL='PAL_BLUE_WHITE_RED' & ATITLE='Temperature Anomaly ' + UNITS('TEMP',/NO_NAME) & END ; APAL='PAL_SUNSHINE_DIF'
      'SST':        BEGIN & DTSET=SST_DATASET & TPSET=SST_TEMP & TPROD=SPROD & DWLPROD='' & PTAG='AMEAN' & PSCALE='SST_0_30' & PAL='PAL_BLUEYELLOWRED'   & GSCALE=PSCALE  & GPAL='PAL_DEFAULT' & ASCALE='DIF_-5_5' & AGSCALE='DIF_-2_2' & APAL='PAL_BLUE_WHITE_RED' & ATITLE='SST Anomaly ' + UNITS('SST',/NO_NAME)  ; APAL='PAL_SUNSHINE_DIF'
