...
FUNCTION PROJECT_VERSION_DEFAULT, PROJECT, VERSION=VERSION, DIR_PROJECT=DIR_PROJECT, TIMESERIES=TIMESERIES, SHAPEFILES=SHAPEFILES
  ...
  BT_DATASET = 'GLORYS' & BT_TEMP = 'GLORYS'
  ACSPO_VERSION = 'V2.81'
  EVENTS = []
  ...
  CASE PROJ OF
    ...
    'SOE_PHYTOPLANKTON': BEGIN
      ...
      SERIES = 'LONGTEMP'
      ADD_DATFILE = 1
      DIRNAMES = ['ANIMATIONS','DATA_EXTRACTS','PPREQ_EXTRACTS','COMPARE_DATA','COMPOSITES','PLOTS','EPU_MAPS','SST','COMPARE','PNGS']
      ...
      PRODS = ['CHLOR_A','PPD','SST','BTEMP','PSC_'+['MICRO','NANO','PICO','FMICRO','FNANO','FPICO']]
    ...
    'ILLEX_OCEAN': BEGIN
      ...
      ADD_MONTHSCALE = 1
      SST_MONTH_SCALE = CREATE_STRUCT('M01', 'SST_0_30',$
        'M02', 'SST_0_30',$
        'M03', 'SST_0_30',$
        'M04', 'SST_5_30',$
        'M05', 'SST_5_30',$
...
; Not sure if the above or below part is correct
  ...
  FOR P=0, N_ELEMENTS(PRODS)-1 DO BEGIN
    ...
    CASE SPROD OF
      ...
      'BTEMP':      BEGIN & DTSET=BT_DATASET  & TPSET=BT_TEMP  & SPROD=SPROD & DWLPROD='' & PTAG='AMEAN' & PSCALE='TEMP_0_20' & PAL='PAL_BLUEYELLOWRED'   & GSCALE=PSCALE  & GPAL='PAL_DEFAULT' & ASCALE='DIF_-5_5' & AGSCALE='DIF_-2_2' & APAL='PAL_BLUE_WHITE_RED' & ATITLE='Bottom Temperature Anomaly ' + UNITS('TEMP',/NO_NAME) & END ; APAL='PAL_SUNSHINE_DIF'
      'SST':        BEGIN & DTSET=SST_DATASET & TPSET=SST_TEMP & TPROD=SPROD & DWLPROD='' & PTAG='AMEAN' & PSCALE='SST_0_30' & PAL='PAL_BLUEYELLOWRED'   & GSCALE=PSCALE  & GPAL='PAL_DEFAULT' & ASCALE='DIF_-5_5' & AGSCALE='DIF_-2_2' & APAL='PAL_BLUE_WHITE_RED' & ATITLE='Surface Temperature Anomaly ' + UNITS('SST',/NO_NAME)  ; APAL='PAL_SUNSHINE_DIF'
  ...
  IF PROJ EQ 'ILLEX_OCEAN' AND MONTH_SCALE NE [] THEN MONTH_SCALE = SST_MONTH_SCALE
