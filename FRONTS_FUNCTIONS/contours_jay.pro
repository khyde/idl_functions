; $ID:	CONTOURS.PRO,	2018-05-24-16,	USER-JEOR	$
;+
;;#############################################################################################################
	FUNCTION CONTOURS_jay,DATA_, BYT = BYT,PROD = PROD,MAPP=MAPP, MED_WIDTH = MED_WIDTH,$
...
IF NONE(C_COLORS)     THEN  C_COLORS = INTERLEAVE(REPLICATE(0,NOF(LEVELS)),REPLICATE(255,NOF(LEVELS)))
