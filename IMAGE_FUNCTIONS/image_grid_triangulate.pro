; $ID:	IMAGE_GRID_TRIANGULATE.PRO,	2020-07-08-15,	USER-KJWH	$

  FUNCTION  image_grid_triangulate, ARR, METHOD=method,MISSING=missing, MIN_VALUE=min_value,MAX_VALUE=max_value
;+
; NAME:
