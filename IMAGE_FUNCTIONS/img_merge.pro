; $ID:	IMG_MERGE.PRO,	2020-07-01-12,	USER-KJWH	$
;#############################################################################################################
	PRO IMG_MERGE,FILES,DIR_OUT=DIR_OUT,$
...
; CATEGORY:	IMG;	
;
; CALLING SEQUENCE: IMG_MERGE,FILES,DIR_OUT=DIR_OUT
;
...
;		
;; EXAMPLES:;
; IMG_MERGE,"C:\IDL\DEMO\ANNUAL-OSTAM-2010_12-SMI-CHLOR_A-MEAN.SAVE",/ADD_NAME,DIR_OUT = !S.IDL_TEMP

;===> MULTIPLE FILES EXAMPLE:
; 1) FILES = FILE_SEARCH('F:\SMI\STATS_PERIODS','M_*SST*.SAVE')
; 2) IMG_MERGE',FILES,DIR_OUT = 'F:\SMI\STATS_BROWSE\',/ADD_NAME
