; $ID:	CIRCLE.PRO,	2020-06-30-17,	USER-KJWH	$
...
; ====================>
; Call IDL USERSYM
  IF KEYWORD_SET(ROTATE) EQ 0 THEN BEGIN
    USERSYM,COS(a),SIN(a),/FILL,COLOR=!P.COLOR,THICK=1,_extra=_extra
  ENDIF ELSE BEGIN
    USERSYM,SIN(a),COS(a),/FILL,COLOR=!P.COLOR,THICK=1,_extra=_extra
  ENDELSE
