; $ID:	PHYSAT_ALVAIN_LOOKUP_TABLE.PRO,	2020-07-08-15,	USER-KJWH	$

	PRO PHYSAT_ALVAIN_LOOKUP_TABLE

;+
; NAME:
;		PHYSAT_ALVAIN_LOOKUP_TABLE
;
; PURPOSE:
...
;-
;	****************************************************************************************************
	ROUTINE_NAME = 'PHYSAT_ALVAIN_LOOKUP_TABLE'
...
; DATE RANGE FOR THE INPUT FILES
  ...
  DIR_PROJECTS = !S.PROJECTS  + 'PHYSAT' + SL
  DIR_LKUP     = DIR_PROJECTS + 'LOOK_UP_FILES' + SL
  DIR_REF      = DIR_PROJECTS + 'NLW_REF' + SL
