; $ID:	A_OC4_5_4TH.PRO,	2020-07-08-15,	USER-KJWH	$


 FUNCTION  A_OC4_5_4TH , Rrs443,Rrs489, Rrs510, Rrs555, NOTES=NOTES, LWN=LWN, COEFFS=coeffs
;+
; NAME:
...
; a = [0.4547,-2.7710,1.7948,-1.1106] ; 3RD ORDER (INCLUDING PALMER_LTER

  A = [0.3010,-3.0325,3.2835,-2.2256] ;  3RD ORDER (EXCLUDING PALMER_LTER
	A = [  0.31437937,  -3.1278270, 2.8298879 , -0.38740315, -1.4066799]
