; $ID:	SIXLIN.PRO,	2020-07-08-15,	USER-KJWH	$
;   NOV 1, 2002
...
;
;  June 4, 2002 JOR
;	 if sxy EQ 0. then $   ; changed to:
;	message,'SXY is zero, Can not compute stats ',/INFORMATIONAL
; (let the program compute nans and infinity and return these to calling program)
;   NOV 1, 2002 JOR CATCH ERRORS WHEN PROBLEM
;-
...
;	===> IF SXY IS ZERO THEN SET ALL SLOPES TO ZERO
 if sxy EQ 0. then $
;      message,'SXY is zero, Can not compute stats ';;;;,/INFORMATIONAL
   SIGN = 1.0 ; JOR
