; $ID:	PHYSAT_MAIN.PRO,	2020-07-08-15,	USER-KJWH	$
...
;
; PURPOSE:;
;		This procedure uses Alvain et al (2008) to identify phtyoplankton functional groups from SeaWiFS
;
; CATEGORY:
;		CATEGORY
;
...
;
;	NOTES:
;	    Alvain, S., Moulin, C., Dandonneau, Y., Loisel, H., 2008.
...
;			Written Jan 21, 2010 by K.J.W.Hyde, 28 Tarzwell Drive, NMFS, NOAA 02882 (kimberly.hyde@noaa.gov)
;-
;	****************************************************************************************************
