; $ID:	IMG_VIEW.PRO,	2020-06-30-17,	USER-KJWH	$
	PRO IMG_VIEW,IMG,COLORS, BACKGROUND=BACKGROUND,PNG=PNG,DELAY=DELAY
;##############################################################################
;+
; NAME:
;		IMG_VIEW
...
W = WINDOW(WINDOW_TITLE = ROUTINE_NAME)
