; $ID:	SUBAREAS_IMAGE_2SHP.PRO,	2020-07-08-16,	USER-KJWH	$

PRO SUBAREAS_IMAGE_2SHP, FILE, SHPFILE=SHPFILE, SUBAREA_CODES=SUBAREA_CODES, REGION=REGION, DIR_OUT=DIR_OUT, OVERWRITE=OVERWRITE, VERBOSE=VERBOSE
...
; ===> Loop through the subareas 
 ...
 ;   STRUCT=REPLICATE({TYPE:0B, HIGH:0B, LEVEL:0, NUM:0L, VALUE:0.0,X:'',Y:''},N_ELEMENTS(PATH_INFO))
    ...
    IF COUNTER EQ 0 THEN BEGIN
      ...
      SHP->ADDATTRIBUTE, 'SUBAREA', 7, STRLEN(ANAME),                PRECISION=0
      SHP->ADDATTRIBUTE, 'REGION',  7, STRLEN(REG),                  PRECISION=0
    ...
    ATTRNEW.ATTRIBUTE_0 = ANAME
    ATTRNEW.ATTRIBUTE_1 = REG
    ATTRNEW.ATTRIBUTE_2 = STRTRIM(ACODE,2)
    ATTRNEW.ATTRIBUTE_3 = METHOD
    ATTRNEW.ATTRIBUTE_4 = SOURCE
    ATTRNEW.ATTRIBUTE_5 = DATE_NOW(/DATE_ONLY)
    ATTRNEW.ATTRIBUTE_6 = CREATOR
