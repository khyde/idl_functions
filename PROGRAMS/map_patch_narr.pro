; $Id:	map_patch_narr.pro,	July 25 2007	$
;
...
FUNCTION  map_patch_narr, Image_Orig, Lons, Lats, $
...
;$$$$$ K. Hyde & J. O'Reilly 7-25-07
;$$$$$screen_x = long([ xw[0] > xw1[0], xw[1] < xw1[1] ] * !d.x_size)
;$$$$$screen_y = long([ yw[0] > yw1[0], yw[1] < yw1[1] ] * !d.y_size)

screen_x = long(ROUND([ xw[0] > xw1[0], xw[1] < xw1[1] ] * !d.x_size))
screen_y = long(ROUND([ yw[0] > yw1[0], yw[1] < yw1[1] ] * !d.y_size))
...
; and split by the map routines.
    for i=0LL, nr-1 do t[i*6] = ([i,i+1,  i, i,i+1,i+1] mod nx) + $
      [0, nx, nx, 0,  0, nx]
