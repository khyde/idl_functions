; $ID:	SAVE_MAKE_GHRSST.PRO,	2020-06-30-17,	USER-KJWH	$
 
PRO SAVE_MAKE_GHRSST, FILES, DIR_OUT=DIR_OUT, MAPS_OUT=MAPS_OUT, LOGLUN=LOGLUN, $
...
; READ IN THE MASK     
    ...
    FOR MTH=0, N_ELEMENTS(MAPS)-1 DO BEGIN
      ...
      IF KEYWORD_SET(ANALYSIS_ERROR) THEN BEGIN
        ...
        ERRSTR = CREATE_STRUCT('ANALYSIS_ERROR',STD.ANALYSIS_ERROR, 'SIMAGE',STD_IMG, 'LONG_NAME',STD.LONG_NAME, 'UNITS','celsius',$
      ...
      STRUCT_WRITE, SST_IMG, FILE=SAVEFILES[MTH], RETURN_STRUCT=RETURN_STRUCT, GLOBAL=GLOBAL, DATA_UNITS=UNITS('SST'), NCFILES=INFILES, FILE_NAME=SAVEFILE, LOGLUN=LOG_LUN, $
