; $Id: IMAGE_STATS.PRO ,v 1.1 1998/02/03 12:00:00 J.E.O'Reilly Exp $

 PRO IMAGE_STATS, FILES=FILES, TYPE=type,$
...
;       IMAGE_STATS, FILES='c:\idl\*.gif'
;       IMAGE_STATS, FILES='c:\idl\*.gif',mask_file='c:\idl\necmask.gif'
...
; ====================>
; If no output file name provided then output ='image_stats.his'
  IF N_ELEMENTS(OUTPUT) LT 1 THEN output ='image_stats.his'
