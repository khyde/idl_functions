...
PN,MAPS 
;==>WRITE A TXTFILE
TXTFILE =!S.MAINFILES + 'MAPS_MAIN.csv'  
...
;*****************************************
  ;===> RESTORE MAPS_MAIN
  SAVEFILE = !S.MAINFILES + 'MAPS_MAIN.SAVE'  & DBF = IDL_RESTORE(SAVEFILE)
...
;     D = MAP_FAOS_FUN(FAO_CODE=FAO_CODE,FAO_NAME=_NAME)
  ...
  ;FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF
  SAVEFILE = !S.MAINFILES + 'MAPS_MAIN.SAVE'
  SAVE,FILENAME = SAVEFILE,DBF,/COMPRESS,/VERBOSE  & PFILE,SAVEFILE,/W
...
;**************************************
  ...
  MAPS =IDL_RESTORE(!S.MAINFILES + 'MAPS_MAIN.SAVE') & MAPS = TAG_NAMES(MAPS)
  PN,MAPS,'MAPS
  DB = MAPS_STRUCT()
...
;***********************************
  ...
  MAPS_MAIN = !S.MAINFILES + 'MAPS_MAIN.csv'
  ...
  IF N_ELEMENTS(DB) GT NMAPS THEN BEGIN
    DB = DB[SORT(DB.MAP)]  
    FILE_COPY, MAPS_MAIN, !S.MAINFILES + 'MAPS_MAIN-' + DATE_NOW() + '.CSV'
...
;**************************************
  ...
  FILE = !S.MAINFILES + 'MAPS_MAIN.csv'
...
IF KEY(DO_MAIN_EDIT_LIMIT_95) THEN BEGIN
  ...
  ;******************************************************
  MSTR = !S.MAINFILES + 'MAPS_MAIN.csv'
