; $ID:	BAR_PLOTS.PRO,	2020-07-08-15,	USER-KJWH	$
;
; Copyright (c) 1990-2004, Research Systems, Inc.  All rights reserved.
;	Unauthorized reproduction prohibited.
;

pro bar_plots,values,baselines=baselines,colors=colors,barnames=barnames, $
          ...
          rotate=rotate,$
          TICKV=TICKV,_EXTRA=_extra ; these two keywords added by JOR
;+
; NAME:
;	BAR_PLOT
;
...
plot,[values],/nodata,title=title,xtitle=xtitle,ytitle=ytitle, $
   ...
   xstyle=1,ystyle=1,/data,background=background,_EXTRA=_EXTRA
if (rotate) then begin				   ;Horizontal bars
