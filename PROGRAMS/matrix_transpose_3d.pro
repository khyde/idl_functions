; $ID:	MATRIX_TRANSPOSE_3D.PRO,	2014-07-27-18	$
;############################################################################3
PRO MATRIX_TRANSPOSE_3D, INPUT_LUN, OUTPUT_LUN, INPUT_DIMENSIONS, PERMUTATION, $
...
;     
; SYNTAX:
;   MATRIX_TRANSPOSE_3D, INPUT_LUN, OUTPUT_LUN, INPUT_DIMENSIONS, PERMUTATION, $
;           DATA_TYPE, MEMGB=MEMGB, PROGRESS=PROGRESS, COMPLETE=COMPLETE, TOTAL=TOTAL
;   
; ARGUMENTS:
...
;-
;**********************************
ROUTINE_NAME = 'MATRIX_TRANSPOSE_3D'
;**********************************
  ...
  PRINT, FORMAT='("*** MATRIX_TRANSPOSE_3D: D0: ", I7, ", D1: ", I7, ", D2: ", I7, '$
  ...
  CASE PERMUTATION_INDEX OF
    ...
    4:  BEGIN ; [2, 0, 1], FORWARD OR ISERIES TO PSERIES
          IF D0 GT 1 THEN BEGIN
            ...
            TEMP_FILE = 'TEMP_TRANSPOSE_FILE'
            OPENW, TEMP_LUN, TEMP_FILE, /GET_LUN
            IF PROGRESS EQ 1 THEN BEGIN
              PRINT, 'MATRIX TRANSPOSE, 1ST OF 2.'
            ENDIF
            MATRIX_TRANSPOSE_3D, INPUT_LUN, TEMP_LUN, [D0, D1, D2], [1, 2, 0], DATA_TYPE, $
            ...
            ENDIF
            MATRIX_TRANSPOSE_3D, TEMP_LUN, OUTPUT_LUN, [D1, D2, D0], [1, 2, 0], DATA_TYPE, $
                  MEMGB=MEMGB, PROGRESS=PROGRESS, COMPLETE=COMPLETE, TOTAL=TOTAL
            CLOSE, TEMP_LUN
          ENDIF ELSE BEGIN
            ...
            ; IS NOT NECESSARY.
            MATRIX_TRANSPOSE_3D, INPUT_LUN, OUTPUT_LUN, [D1, 1, D2], [1, 2, 0], DATA_TYPE, $
