; $ID:	DOC_MANNINO_SMAB.PRO,	2020-07-08-15,	USER-KJWH	$

 FUNCTION DOC_MANNINO_SMAB, A_CDOM_355=A_CDOM_355, DATE=DATE,  REFRESH=refresh, ERROR=ERROR
...
;
;	PROCEDURE:
;		This algorithm for the South Mid-Atlantic Bight uses two seasonal functions relating ACDO at 355nm to Dissolved Organic Carbon (micromolar):
...
;	===> Compute DOC according to Winter and Summer Functions
	DOC_WINTER = 1/ ( ALOG(DOUBLE(A_CDOM_355[OK]))*(-0.0047465) + 0.0075058)
	DOC_SUMMER = 1/ ( ALOG(DOUBLE(A_CDOM_355[OK]))*(-0.0030323) + 0.0061522)
