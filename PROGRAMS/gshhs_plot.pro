PRO GSHHS_PLOT, FILE, LEVEL=LEVEL, MINAREA=MINAREA, COLOR=COLOR, BACKGROUND=BACKGROUND, LAND_COLOR=LAND_COLOR, WATER_COLOR=WATER_COLOR,$
...
; Mar 22, 2016 - KJWH: Added several updates based on David Fanning's MAP_GSHHS_SHORELINE http://www.idlcoyote.com/programs/retired/map_gshhs_shoreline.pro
...
; ===> Defauls
  ...
  IF NONE(LEVEL)       THEN LEVEL = 2 ELSE LEVEL = 1 > LEVEL < 4    ; Lake
...
; ===> Check level and area of this polygon
    IF POLYGONLEVEL GT LEVEL OR POLYGONAREA LE MINAREA THEN CONTINUE
