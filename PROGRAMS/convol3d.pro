; $ID:	CONVOL3D.PRO,	2020-07-08-15,	USER-KJWH	$
;Viewing contents of file '/net/www/deutsch/idl/idllib/astron/contrib/varosi/vlib/allpro/convol3d.pro'
...
function convol3d, voldata, psf, FT_PSF=psf_FT, FT_VOLDATA=vdFT, NO_FT=noft, $
	...
	if Keyword_Set( no_psf_FT ) then begin
		...
		L = (s + sv-1) < (sp-1)
		psf_FT = complexarr( sv[1], sv(2), sv(3) )
