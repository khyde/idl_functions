; $Id: WEIGHT_TRICUBE.pro $  VERSION: March 26,2002
;+
;	This Function returns weights using the WEIGHT_TRICUBE function
; SYNTAX:
;
;	Result  = WEIGHT_TRICUBE(Arr,Cen)
; OUTPUT:
; ARGUMENTS:
...
FUNCTION WEIGHT_TRICUBE, ARRAY, CENTER
  ROUTINE_NAME='WEIGHT_TRICUBE'

  MAX_DIST = MAX(ABS(CENTER - DOUBLE(ARRAY))) ; maximum distance from cen to either end

  RETURN, (1.0d - (ABS( (CENTER-ARRAY)/ MAX_DIST ) )^3)^3
