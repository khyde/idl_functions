; $ID:	DETREND_POLY.PRO,	2020-07-08-15,	USER-KJWH	$
;Viewing contents of file '/net/www/deutsch/idl/idllib/ssw/allpro/detrend.pro'

FUNCTION DETREND_POLY, y, yd, ORDER=order
